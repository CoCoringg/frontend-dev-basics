...
public class RestApiController {
	...
	public JSONResult read() {
		...
		vo2.setNo(2L);
		vo2.setName("마이콜");
		vo2.setEmail("michol@mysite.com");
		vo2.setGender("male");
		list.add(vo2);
	...
	@PutMapping("/{no}")
	public JSONResult updateput(@PathVariable("no") Long no, @RequestBody UserVo vo) {
